...
\date{The University of Utah\\{\footnotesize(virtual)}\\June 28, 2021}
...
% ------------------------------------------------------------------------------
\section{Part II: Other Projects and Future Research}

%-------------------------------------------------------------------------------
\begin{frame}[t]
	\usebeamertemplate{section intro}{}{}
	\textcolor{uscgold}{
		\Large {\bf Part II: Other Projects and Future Research}
	}
\end{frame}
...
%	\centering
	\Large \color{uscgold}{\bfseries Continue developing scientific software...} \normalsize
	\vspace{-1cm}
	\includegraphics[width=1.1\linewidth]{networks2021-copresenters.png}	
	\vspace{-15cm}

	\begin{figure}
		\includegraphics[width=.9\linewidth]{fig-packages/hexlogos.png}
	\end{figure}
