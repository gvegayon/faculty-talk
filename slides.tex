...
\date{The University of Utah\\{\footnotesize(virtual)}\\June 14, 2021}
...
\begin{frame}[t]
	\usebeamertemplate{section intro}{}{}
	\textcolor{uscgold}{
		\Large {\bf A general framework for modeling functional evolution} \vskip0.25em
...
\begin{frame}[c]
	...
	\begin{center}
		...
		\begin{minipage}[m]{.49\linewidth}
			\mode<beamer>{%
				\includegraphics<3->[width=1\linewidth]{geese-equation-prediction.pdf}
			}%
			\mode<handout>{%
				\includegraphics[width=1\linewidth]{geese-equation-prediction.pdf}
			}
		\end{minipage}
...
% ------------------------------------------------------------------------------
\section{Part 3: Other Projects and Future Research}

%-------------------------------------------------------------------------------
\begin{frame}[t]
	\usebeamertemplate{section intro}{}{}
	\textcolor{uscgold}{
		\Large {\bf Part 3: Other Projects and Future Research}
	}
\end{frame}
...
\uncover<2->{\byside{.33}{Sociology}{Using ERGMitos to model political discussion networks in Romania}}\hfill
\uncover<3->{\byside{.33}{Criminology}{The role of social networks on police use of force}}\hfill
\uncover<4->{\byside{.33}{Statistical Computing}{Leverage computing power to advance theory and application for studying complex systems...}}
...
\includegraphics[width=.9\linewidth]{airports-netplot.png}
\end{minipage}}
...
\begin{frame}
	...
	\begin{figure}
		\includegraphics[width=1\linewidth]{fig-packages/hexlogos.png}
	\end{figure}
\end{frame}

\begin{frame}
	\usebeamertemplate{section intro black}
	\centering
	\vspace{-1cm}
	\includegraphics[width=1\linewidth]{networks2021-copresenters.png}	
\end{frame}
