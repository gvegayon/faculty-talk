...
\uncover<2->{\byside{.32}{Statistics}{\bigskip\includegraphics[width=.8\linewidth]{mcmc.png}}}
\uncover<3->{\byside{.32}{Computer Science}{\bigskip\includegraphics[width=.8\linewidth]{time.png}}}
\uncover<4->{\byside{.32}{Complex Systems}{\bigskip\includegraphics[width=.8\linewidth]{complex.png}}}
...
\begin{frame}
	\frametitle{About gene functions and family trees}
	\begin{figure}
		\includegraphics[width=1\linewidth]{aphylo-data.pdf}
	\end{figure}
\end{frame}
...
\begin{frame}[label=aphylo-results-overview]
	...
	\begin{itemize}
		...
		estimation of parameters using a pooled-data model. \hyperlink{aphylo-model-levels}{\beamerreturnbutton{modeling}} \hyperlink{aphylo-table}{\beamerreturnbutton{estimates}}\pause
